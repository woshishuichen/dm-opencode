...
<form  onsubmit="javascript:return checkhere(this)" action="<?php echo $jumpv_insert;?>" method="post">
  <table class="formtab">
    <tr>
      <td width="12%" class="tr">页头的样式：</td>
      <td width="88%"> 

      背景色：<input name="header_bgcolor" type="text"  value="<?php echo $header_bgcolor;?>" size="20" />
...
<div class="inputclear"></div>
字体颜色：<input name="header_color" type="text"  value="<?php echo $header_color;?>" size="20" />
 <?php spancolor($header_color);?>
<div class="c15"></div>
<strong>链接的颜色：</strong>
<div class="c5"></div>
默认时：
<input name="header_color_a" type="text"  value="<?php echo $header_color_a;?>" size="20" />
<?php spancolor($header_color_a);?>
  <span class="inputhengdivi"></span>
   鼠标移上时：
<input name="header_color_ahover" type="text"  value="<?php echo $header_color_ahover;?>" size="20" />
   ...
   <tr>
      ...
      背景色：<input name="footer_bgcolor" type="text"  value="<?php echo $footer_bgcolor;?>" size="20" />
...
<div class="inputclear"></div>
字体颜色：<input name="footer_color" type="text"  value="<?php echo $footer_color;?>" size="20" />
...
<div class="c5"></div>
默认时：
<input name="footer_color_a" type="text"  value="<?php echo $footer_color_a;?>" size="20" />
     <?php spancolor($footer_color_a);?>
   <span class="inputhengdivi"></span>
   鼠标移上时：
<input name="footer_color_ahover" type="text"  value="<?php echo $footer_color_ahover;?>" size="20" />
