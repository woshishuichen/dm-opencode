...
<form  onsubmit="javascript:return checkhere(this)" action="<?php echo $jumpv_insert;?>" method="post">
  <table class="formtab">
     ...
     <tr>
      <td   class="tr">页面宽度：</td>
      <td > 
        <input name="pagewidth" type="text"  value="<?php echo $pagewidth;?>" size="30" /> 
         比如：1200px
         </td>
    </tr>
    ...
    <tr>
     ...
     页面的背景色：<input name="body_bgcolor" type="text"  value="<?php echo $body_bgcolor;?>" size="20" />
     <?php spancolor($body_bgcolor);?>
<div class="c5"></div>
页面的背景图片：<input name="body_bgimg" type="text"  value="<?php echo $body_bgimg;?>" size="50" />
 ...
 <select name="body_bgimgset">
    <?php select_from_arr($arr_body_bgset,$body_bgimgset,'');?>
     ...
     <tr>
      ...
      <td > 
      页面字体颜色：
   <input name="color_body" type="text"  value="<?php echo $color_body;?>" size="20" />
   <?php spancolor($color_body);?>
 <div class="inputclear"> </div>
 <strong>链接的颜色：</strong>
   <br />
     默认时：<input name="color_a" type="text"  value="<?php echo $color_a;?>" size="20" />
     <?php spancolor($color_a);?>
  <span class="inputhengdivi"></span>
   鼠标移上时：
   <input name="color_ahover" type="text"  value="<?php echo $color_ahover;?>" size="20" /><?php spancolor($color_ahover);?>
      </td>
    </tr>
