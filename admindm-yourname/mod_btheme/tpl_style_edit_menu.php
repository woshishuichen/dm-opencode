...
<form  onsubmit="javascript:return checkhere(this)" action="<?php echo $jumpv_insert;?>" method="post">
  ...
  <tr>
      <td   class="tr">主菜单的模板：</td>
      <td > 

   高度：
   <input name="menu_height" type="text"  value="<?php echo $menu_height;?>" size="20" />
   比如：60px
   <div class="inputclear"> </div>

   下划线样式：
   <input name="menu_border" type="text"  value="<?php echo $menu_border;?>" size="50" />
   比如：1px solid red
   ...
   <div class="inputclear"> </div>
     ...
     <strong>默认时:</strong>
      <br />
 背景色： <input name="menu_bgcolor" type="text"  value="<?php echo $menu_bgcolor;?>" size="20" />
...
链接颜色：  <input name="menu_color" type="text"  value="<?php echo $menu_color;?>" size="20" />
   <?php spancolor($menu_color);?>
 <div class="inputclear"> </div>

<strong>鼠标移上去时:</strong><br />
 背景色 <input name="menu_bgcolor_h" type="text"  value="<?php echo $menu_bgcolor_h;?>" size="20" />
...
背景图片：  <input name="menu_bgimg_h" type="text"  value="<?php echo $menu_bgimg_h;?>" size="30" />
 <?php   echo  p2030_imgyt($menu_bgimg_h,'y','y'); 
       ?> 
 <br />链接颜色：  <input name="menu_color_h" type="text"  value="<?php echo $menu_color_h;?>" size="20" />
 ...
 <tr>
      <td   class="tr">下拦子菜单的模板：</td>
      <td > 

   高度：
   <input name="msub_height" type="text"  value="<?php echo $msub_height;?>" size="20" />
   比如：30px

   <div class="inputclear"> </div>

   下划线样式：
   <input name="msub_border" type="text"  value="<?php echo $msub_border;?>" size="50" />
   比如：1px solid red
   <div class="inputclear"> </div>

     <strong>默认时:</strong>
      <br />
 背景色： <input name="msub_bgcolor" type="text"  value="<?php echo $msub_bgcolor;?>" size="20" />
   <?php spancolor($msub_bgcolor);?>
  <span class="inputhengdivi"></span>
链接颜色：  <input name="msub_color" type="text"  value="<?php echo $msub_color;?>" size="20" />
   <?php spancolor($msub_color);?>
 <div class="inputclear"> </div>

<strong>鼠标移上去时:</strong><br />
 背景色 <input name="msub_bgcolor_h" type="text"  value="<?php echo $msub_bgcolor_h;?>" size="20" />
   <?php spancolor($msub_bgcolor_h);?>
  <span class="inputhengdivi"></span>

 链接颜色：  <input name="msub_color_h" type="text"  value="<?php echo $msub_color_h;?>" size="20" />
