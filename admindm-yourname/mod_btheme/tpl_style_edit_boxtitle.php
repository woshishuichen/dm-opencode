...
<form  onsubmit="javascript:return checkhere(this)" action="<?php echo $jumpv_insert;?>" method="post">
  <table class="formtab">
   ...
   <tr>
      <td   class="tr">传统盒子：</td>
      <td > 
      高度：  <input name="boxtitle_height" type="text"  value="<?php echo $boxtitle_height;?>" size="10" />
        比如：40px
       <div class="c15"> </div>
      背景色：   
   <input name="boxtitle_bgcolor" type="text"  value="<?php echo $boxtitle_bgcolor;?>" size="20" />
   <?php spancolor($boxtitle_bgcolor);?>
 <div class="c15"> </div>
 背景图片：<input name="boxtitle_bgimg" type="text"  value="<?php echo $boxtitle_bgimg;?>" size="50" />
<?php   echo  p2030_imgyt($boxtitle_bgimg,'y','y'); 
       ?> 
 <div class="c15"> </div>
 字体的颜色： 
   <input name="boxtitle_color" type="text"  value="<?php echo $boxtitle_color;?>" size="20" />
