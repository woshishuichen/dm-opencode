...
<div class="fl curstyle">当前模板：<span style="color:#2480C4">
<?php 
echo get_field(TABLE_STYLE,'title',$curstyle,'pidname').' - '.$curstyle;
 ?></span>
</div>
...
<li class="main"><a href="../mod_btheme/mod_style.php?lang=<?php echo LANG?>">模板管理</a></li>
  ...
  <li class="main"><a href="../mod_page/mod_page.php?lang=<?php echo LANG?>">单页面管理</a></li>
 ...
 <div class="poa dn xialabox">
  ...
  <li class="main navblock"><a href="javascript:void(0)" style="cursor:default">区块管理</a>
	  <div  class="poa dn xialabox">
...
function blocksub() {
	global $pidregion;global $superadmin;
 if($superadmin=='y')   echo '<strong>区块：</strong>';
	 echo  '<a target="_blank" href="../mod_block/mod_block.php?lang='.LANG.'">图文区块管理</a>';
   echo  '<a target="_blank" href="../mod_block/mod_nodelist.php?lang='.LANG.'">效果区块管理</a>';

  if($superadmin=='y')   echo  '<a target="_blank" href="../mod_category/mod_taxo.php?lang='.LANG.'&type=blockdh">效果区块的内容</a>';
  
 echo  '<a target="_blank" href="../mod_region/mod_regcommon.php?lang='.LANG.'&type=common">组合区块管理</a>'; 
   
  
	if($superadmin=='y')  
		{
			 echo '<strong>区域：</strong>';
			 echo  '<a href="../mod_region/mod_region.php?lang='.LANG.'&type=index">页面区域管理</a>';
   echo  '<a href="../mod_region/mod_region.php?lang='.LANG.'&type=index&file=sub&pid='.$pidregion.'">首页区域管理</a>';
   echo  '<a href="../mod_region/mod_region.php?lang='.LANG.'&type=index&file=sub&pid=regionindex20160725_0848355370">可复制区域管理</a>';
...
function regionsub() {
	global $pidregion;global $superadmin;
	if($superadmin=='y')  echo  '<a href="../mod_region/mod_region.php?lang='.LANG.'&type=index">页面区域管理</a>';

   echo  '<a href="../mod_region/mod_region.php?lang='.LANG.'&type=index&file=sub&pid='.$pidregion.'">首页区域管理</a>';
 
  echo  '<a href="../mod_region/mod_regcommon.php?lang='.LANG.'&type=common" target="_blank">公共区域管理</a>'; 
}//end func
...
echo  '<a href="../mod_ddorder/mod_ddproduct.php?lang='.LANG.'">订单的产品管理</a>';
 ...
 function imgfjsub() {
 	global $curstyle;
 echo  '<a class="needpopup" href="../mod_imgfj/mod_imgfj.php?pid=name&lang='.LANG.'"  >名称附件管理</a>';
 echo  '<a class="needpopup" href="../mod_imgfj/mod_imgfj.php?pid=common&lang='.LANG.'" >公共编辑器附件管理</a>';
