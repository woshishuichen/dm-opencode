...
if(!defined('IN_DEMOSOSO')) {
  ...
  if($act=='update')
 {
  ...
  $despjj=zbdespadd2($abc6); 


//usr linkcss,not use linkstyle
 $ss = "update ".TABLE_REGION." set titleboxcssname='$abc1',titlestyle='$abc2',titleimg='$abc3',titlelinewrap='$abc4',titleline='$abc5',despjj='$despjj',titlestylesub='$abc7' where id='$tid' $andlangbh limit 1";
			iquery($ss); 	
