...
//$desp = zbdespadd2($abc3);	
   ...
   // $ss = "insert into " . TABLE_BLOCK . " (pbh,pid,pidname,lang,name,linkurl,kv,type,desptext,desp,dateedit) values ('$user2510','$pidname','$pidnamecur','" . LANG . "','$abc1','$abc2','$return_v','dhsub','$text1','$desp','$dateall')"; 
    $ss = "update " . TABLE_BLOCK . " set name='$abc1',despjj='$abc2',cssname='$abc3',linkurl='$abc4',more='$abc5',sta_name='$abc6',blockcntid='$abc7' $kv_v,desptext='$desptext',desp='$desp',dateedit='$dateall' where type='vblock' and id='$tid' $andlangbh limit 1";
    //echo $ss;exit;
    iquery($ss);
    //alert("修改成功");
...
if ($act == 'edit') {
    ...
    $kv = $rowsub['kv'];
    $name = $rowsub['name'];  $sta_title = $rowsub['sta_name'];  
...
<form  onsubmit="javascript:return checkhere(this)" action="<?php echo $jump_insertimg; ?>" method="post" enctype="multipart/form-data">
    <table class="formtab">
        ...
        <tr>
            ...
            <td width="88%"> <input name="linkurl" type="text"  value="<?php echo $linkurl; ?>" size="70"><?php echo $xz_maybe; ?>  
<?php echo $link_tip; ?>
