...
if($act == "insert")
{
	...
	$arr_can='sta_noaccess:##n==#==pagelayout:##noallwidth==#==downloadurl:##==#==videourl:##==#==videotitle:##==#==seocus1:##==#==seocus2:##==#==seocus3:##';
...
<table class="formtab">
  <tr>
    <td width="12%" class="tr">名称：</td>
    <td width="88%"> <input name="name" type="text" id="name" value="" size="30">
