...
?>
 ...
 <a href='<?php echo $jumpv;?>'>返回字段管理</a>
 </h2>
...
<table class="formtab">
  ...
  <tr>
    ...
    <td width="88%"><input name="name" type="text" id="name" value="<?php echo $name;?>" size="50">
    <?php echo $xz_must;?>
     </td>
  </tr>
   <tr>
    ...
    <td width="88%"><input name="cssname" type="text" id="cssname" value="<?php echo $cssname;?>" size="30">
    <?php echo $xz_maybe;?>
     </td>
  </tr>
