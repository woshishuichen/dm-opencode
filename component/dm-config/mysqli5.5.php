...
$mysqli_password="";  
$mysqli_database="demomb_baibianxingjun";   // in index.php $userdir='cm_testcopy';
   
 
/*if mysql5.5 ,use code below*/
$conn = mysqli_connect( 
 $mysqli_server_name, /* The host to connect to 连接MySQL地址 */  
  $mysqli_username,   /* The user to connect as 连接MySQL用户名 */  
 $mysqli_password, /* The password to use 连接MySQL密码 */  
 $mysqli_database);  /* The default database to query 连接数据库名称*/  
