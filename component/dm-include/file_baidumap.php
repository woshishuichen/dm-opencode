...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(<?php echo $bdp1?>,<?php echo $bdp2?>);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"<?php echo $bdtitle?>",content:"<?php echo $bddesp?>",point:"<?php echo $bdp1?>|<?php echo $bdp2?>",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];    
