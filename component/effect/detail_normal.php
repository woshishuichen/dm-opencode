...
editlink($row_detail['id'],'node');//in global.common.php
...
if($detlinkurl<>'') echo '<div class="detaillinkurl ptb10 dmbtn moresm moresmw"><a class="more" href="'.$detlinkurl.'" target="_blank"><i class="fa fa-shopping-cart"></i> '.$shop_linktitle2.'</a></div>';

} //hide price part

//输出字段属性:
if($sta_field=='y'){ if($field_title=='') $field_title='请在后台输入值';
echo '<div class="bodyheader"><h3>'.$field_title.'</h3></div>';
...
if($albumposi=='y') require_once EFFECTROOT.'album.php';
require_once EFFECTROOT.'plugin_nextprev.php';
 ?>